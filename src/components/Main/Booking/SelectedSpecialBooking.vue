        ...
        <div class="full-page-content-inner">
          <div class="container-fluid">
            <div>
              ...
              >
              <h4>{{ timeDetails.minutes }}m : {{ timeDetails.seconds }}s Hurry! use this code <b>WhavFirst</b> to get N1000 discount on your first order</h4>
              </b-alert>
            </div>
            <div class="dashboard-headline text-center">
              <h3 style="text-transform:capitalize;">Let's Help With Your {{displayCleaningType()}} Cleaning, Start Here!</h3>
            </div>
            <div>
            </div>
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-lg-9" >
                  ...
                  <form @submit.prevent="submit">
                    <vue-good-wizard :steps="steps" :onNext="nextClicked" :onBack="backClicked">
                      <div slot="page1">
                        <fieldset id="form" class="dashboard-box margin-top-0 border-primary">
                          <div class="headline">
                            <h4 class="text-primary">
                              1. We Want To Know More About Your {{ capitalize((this.$route.query.cleaning_type === "mattress") ? "Mattress Hygiene" :  `${this.$route.query.cleaning_type} Cleaning`) }} Request
                            </h4>
                          </div>
                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="switches-list">
                                  <div
                                    ...
                                    :key="service.id"
                                  > 
                                    <!-- <label class="switch" v-if="service.title.indexOf(capitalize($route.query.cleaning_type)) !== -1">
                                      <input
                                        type="checkbox"
                                    ...
                                    <!-- <div class="mt-1"  :id="'cards'+service.id" v-if="service.attribute_name.length >= 1"> -->
                                    <div class="mt-1"  :id="'cards'+service.id" v-if="service.attribute_name.length >= 1 && service.title.indexOf(capitalize($route.query.cleaning_type)) !== -1">
                                      <ul class="list-group ml-4"
                                        v-for="(attribute,index) in service.attribute_name"
                                        :key="`a${index}`">
                                      <h3 class="text-capitalize text-center ml-4">{{ attribute.name }}</h3>
                                      <div class="attribute-input">
                                        ...
                                        >
                                          <div class="col-lg-12">
                                            <img class="attribute-image" :src="attr.image_icons" alt="image">
                                                <label class="attribute-label" :for="`radio-2${attr.id}`" style="text-transform:capitalize">
                                                  <span>
                                                    {{ attr.measurement }}
                                                  </span>
                                                </label>
                                              <input v-if="$route.query.cleaning_type === 'fumigation'" type="number" :placeholder="placeHolderValue" min="0" max="10" oninput="validity.valid||(value='');" @input="checkMetaFumigation(attr,attribute,$event.target.value)" >
                                              <input v-else type="number" :placeholder="placeHolderValue" min="0" oninput="validity.valid||(value='');" v-model="otherServicesInput[attr.id]" @input="checkMeta(attr, $event.target.value)" >
                                          </div>
                                        </li>
                                      </div>
                                      </ul>
                                    </div>
                                    <div class="mt-1"  :id="'cards'+service.id" v-else-if="service.attribute_name.length >= 1 && service.title === 'AC Servicing and Disinfection' && $route.query.cleaning_type == 'ac'">
                                      <ul class="list-group ml-4"
                                        v-for="(attribute,index) in service.attribute_name"
                                        :key="`a${index}`">
                                      <h3 class="text-capitalize text-center ml-4">{{ attribute.name }}</h3>
                                        ...
                                        >
                                          <div class="col-lg-12">
                                            <img class="attribute-image" :src="attr.image_icons" alt="image">
                                              ...
                                              <input type="number" :placeholder="placeHolderValue" min="0" oninput="validity.valid||(value='');" v-model="otherServicesInput[attr.id]" @input="checkMeta(attr, $event.target.value)" >
                                          </div>
                                        </li>
                                      </div>
                                      </ul>
                      ...
                      <div slot="page2">
                        <fieldset id="form" class="dashboard-box margin-top-0 border-primary">
                          <div class="headline">
                            <h4 class="text-primary">
                              2. Choose Other Special Cleaning Services?
                            </h4>
                          </div>
                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="switches-list">
                                  ...
                                  > 
                                    ...
                                    <div class="mt-1"  :id="'cards'+service.id" v-if="service.attribute_name.length >= 1 && service.clicked === 'clicked'+service.id">
                                      <ul class="list-group ml-4 attribute-input"
                                        v-for="(attribute,index) in service.attribute_name"
                                        :key="`a${index}`">
                                        ...
                                        >
                                          ...
                                          <input type="number" @input="checkMeta(attr, $event.target.value)" >
                                        </li>
                      ...
                      <div slot="page3">
                        <fieldset id="form" class="dashboard-box margin-top-0 border-primary">
                          ...
                          <div class="content with-padding">
                            <div class="row">
                              <div class="col-lg-12">
                                <h4 class="text-muted">Extra Cleaning You Want?</h4>
                                <p>We can offer cleaning for areas your want but cleaning type doesn't cover.</p>
                                ...
                                <div class="switches-list">
                                  ...
                                  >
                                    ...
                                    <label class="switch mt-2">{{ extra.title }}
                                      <input type="checkbox" 
                      ...
                      <div slot="page4">
                        <fieldset id="form" class="dashboard-box margin-top-0 border-primary">
                          <div class="headline">
                            <h4 class="text-primary">
                              <i class="icon-material-outline-access-time"></i> Timing and Location
                            </h4>
                          </div>
                          ...
                          <div class="content with-padding">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <div class="form-group form-row">
                                  <div class="required col-md-6">
                                    <label for="location" class="text-muted">Select Location <small class="float-right mr-lg-3">or location closest to you</small></label>
                                    
                                    <select name id="location" class="border full-booking-select" v-model="location">
                                      <option :value="previouslySelectedLocation" :selected="true" v-if="previouslySelectedLocation !== null">
                                    ...
                                    <div v-if="location_error">
                                      <h6 class="feedback">Location is required</h6>
                                    </div>
                                  </div>
                                  <div class="required col-md-6">
                                    ...
                                    <div v-if="address_error">
                                      <h6 class="feedback">Address is required</h6>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-lg-12 form-inline">
                                <div class="form-group">
                                    <label for="discount_code" class="text-muted">Discount Code</label>
                                    <input
                                      type="text"
                                      class="border"
                                      id="discount_code"
                                ...
                                <div class="form-group ml-4 mt-2">
                                  <button id="removeDiscount" @click.prevent="removeDiscount()" class="btn btn-md btn-danger" hidden="true">Remove Discount</button>
                                  <button id="addDiscount" @click.prevent="checkDiscount()" type="button" class="btn btn-md btn-primary">Apply Code</button>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="content with-padding">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <div class="form-group form-row">
                                  <div class="col-md-12">
                                    <h5 class="my-2 text-muted">Select Payment method:</h5>
                                    ...
                                    >
                                    Pay & Complete Booking &#8358;{{ formatPrice(calculatePrice - discount_fixed_price) }}
                                    </button>
                                    <button
                                      v-else
                                      type="submit"
                                      class="btn btn-primary btn-lg mt-3 text-center"
                                    >
                                    Pay & Complete Booking &#8358;{{ formatPrice(calculatePrice - (this.discount_percentage * calculatePrice)) }}
                                    </button>
                                    <GuaranteeView />
                                  </div>
                                </div>
                                ...
                                <div v-if="$v.$error">
                                  <span class="text-danger text-bold mt-1" v-if="!$v.product.required">* Product Category is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.email.required">* Email is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.payment_method.required">* Payment Method is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.no_of_rooms.required">* No of Rooms is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.schedule.required">* Schedule must be selected</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.last_name.required">* Last Name is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.first_name.required">* First Name is required</span>
                                  ...
                                  <span class="text-danger text-bold mt-1" v-if="!$v.password.required">* Password is required</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.password.minLength">* Password cannot be less than 8 characters</span>
                                  <span class="text-danger text-bold mt-1" v-if="!$v.email.email">* Email must be a valid email address</span>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="col-lg-3 col-md-3 side-bar d-none d-lg-block d-xl-block d-md-none">
                    ...
                    <div class="sidebar-info-block">
                      <div class="">
                        <div class="">
                            ...
                            <div class="checkout-row info-row">
                              <div class="payment-info-content info-sidebar-text">
                                  <div class="">
                                    ...
                                    <span class="text-white" style="text-transform:Capitalize;">{{ schedule }} -</span> <span class="text-white"> Cleaning Schedule</span>
                                  </div>
                                  <div v-if="product != null">
                                    <small class="text-white">Areas to be cleaned</small>
                                    <ul class="mr-5">
                                      <li v-for="(area,index) in product.area" :key="index" class="text-white"><small>{{ area.title }}</small></li>
                                    </ul>
                                  ...
                                  <div class="home-hero-form editable-summary">
                                    <div class="pad-top">
                                        <div class="form-group text-white">
                                          <span v-if="start_date">{{ customFormatter(start_date) }} @ {{ time }}</span> 
                                        </div>
                                        <!-- <div class="form-group text-white">
                                            <span>
                                            1 bed, 1 bath (up to
                          ...
                          <div class="mb-5" id="">
                              <div data-commitment-unit="months" id="commitment"></div>
                              <div class="payment-section">
                                  <div class="checkout-row">
                                      <div class="payment-summary-credits payment-summary-row hidden" style="">
                                        <div class="float-left text-white">Per cleaning</div>
                                        <div class="float-right text-white">&#8358; {{ formatPrice(calculatePrice) }}</div><br>
                                        <div v-if="discount_type !== 'fixed'">
                                            <div class="float-left text-white">Coupon</div>
                                            <div class="float-right text-white"> {{ this.discount_percentage }}%</div><br>
                                        </div>
                                        <!-- <div class="float-left text-white">Special Offer</div>
                                        <div class="float-right text-white">– &#8358; 0.00</div><br> -->
                                        <div class="float-left text-white">Discount</div>
                                        <div v-if="discount_type === 'fixed'" class="float-right text-white">- &#8358; {{ formatPrice(discount_fixed_price) }}</div>
                                        <div v-else-if="discount_type === 'percentage'" class="float-right text-white">- &#8358; {{ formatPrice(this.discount_percentage * calculatePrice) }}</div>
                                        <div v-else class="float-right text-white">- &#8358; {{ formatPrice(calculatePrice) }}</div>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <hr class="hr-bg-white bg-white">
                            <div class="checkout-row total-price-row">
                                ...
                                <div class="float-right mt-3">
                                  <h3 v-if="discount_type === 'fixed'" class="text-white">
                                    &#8358; {{ formatPrice(calculatePrice - discount_fixed_price) }}
                                    <!-- <small class="text-white">.00</small> -->
                                  </h3>
                                  <h3 v-else class="text-white">
                                    &#8358; {{ formatPrice(calculatePrice - (this.discount_percentage * calculatePrice)) }}
                                    <!-- <small class="text-white">.00</small> -->
                                  </h3>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 thing_to_stick pricing-row d-block d-sm-block d-md-none">
                  <div class="bg-primary pl-2 p-2" style="margin-right: 15px;margin-left: -20px;">
                    <div class="sidebar-info-block ">
                      <div class="">
                        <div class="">
                          <div class="payment-section">
                              ...
                              <div class="payment-section">
                                  <div class="checkout-row">
                                      <div class="payment-summary-credits payment-summary-row hidden" style="">
                                        ...
                                        <div class="float-right text-white">– &#8358; 0.00</div><br> -->
                                        <div class="float-left text-white">Discount</div>
                                        <div class="float-right text-white">- &#8358; {{ formatPrice(this.discount_percentage * calculatePrice) }}</div>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="checkout-row total-price-row">
                              ...
                              <div>
                                ...
                                <b-link href="#" v-b-modal.modal-1 class="float-left text-white"><u>view details</u></b-link>
                                <!-- <b-button variant="outline-primary">Button</b-button> -->

                                <!-- Modal to view prices on mobile view -->
                                <b-modal size="sm" id="modal-1" title="Pricing Details">
                                  <p class="my-4"><b>Per Cleaning:</b> {{ formatPrice(calculatePrice) }}</p>
                                  <p v-if="discount_type !== 'fixed'" class="my-4"><b>Coupon:</b> {{ this.discount_percentage }}%</p>
                                  <p v-if="discount_type === 'fixed'" class="my-4"><b>Discount:</b> {{ formatPrice(discount_fixed_price) }}</p>
                                  <p v-else class="my-4"><b>Discount:</b> {{ formatPrice(this.discount_percentage * calculatePrice) }}</p>
                                  <p v-if="discount_type === 'fixed'" class="my-4"><b>Total: &#8358;{{ formatPrice(calculatePrice - discount_fixed_price) }}</b></p>
                                  <p v-else class="my-4"><b>Total: &#8358;{{ formatPrice(calculatePrice - (this.discount_percentage * calculatePrice)) }}</b></p>
...
export default {
  ...
  data() {
    return {
      steps: [
        ...
        //(this.$route.query.cleaning_type !== "fumigation") ? steps : {}
        // We dont need these for individual cleaning types
        // {
        //   label: 'Other Special Cleaning',
        //   slot: 'page2',
        // },
        // {
  ...
  methods: {
     displayCleaningType(){
      if (this.$route.query.cleaning_type === "mattress") {
        return "Mattress Hygiene";
      }

      if (this.$route.query.cleaning_type === "floor") {
        return "Floor Restoration Cleaning";
      }

      return `${this.$route.query.cleaning_type}`;
    },
    changetime(){
      this.time_error = !this.time_error;
      console.log(this.time_error);
    },
    formatPrice(value) {
      let val = value;
      val = parseFloat(val);
    ...
    checkService(service) {
      if(service.hasOwnProperty('clicked') == false && service.attribute_name.length >= 1) {
    ...
    checkMetaFumigation(attr,attribute,meta_amount) {
      ...
      if(this.meta.some(el => el.id == attr.id) == false){
        Object.assign(attr, {meta_main_price: (FumigationPricingMap[meta_amount]) ? FumigationPricingMap[meta_amount] : 0});
        this.meta.push(attr);
        ...
        if(this.discount_code !== null) {
          ...
          .then(res => {
            ...
            if (discount != null) {
              ...
              (discount.discount_type === "percentage") ? this.discount_percentage = discount.percentage : this.discount_fixed_price = discount.fixed_price;
            }
            loader.hide();
    ...
    addDiscount(booking) {
      ...
      if(this.token !== null && this.discount_code !== null) {
        this.$http({
            url: this.base + "booking/"+bookingId+"/update/discount/add/"+this.discount_code+"?token="+this.token,
            method: "PUT"
          })
          .then(res => {
            let discount = res.data.data;
          ...
          .then(res => {
            ...
            this.$swal
              ...
              .then(res => {
                ...
                this.$router.push(
                  "/user/dashboard/request/" + booking_id
                );
              });
    ...
    makeBooking() {
      ...
      if (this.meta.length > 0) {
        for (let index = 0; index < this.meta.length; index++) {
          service_attributes.push([this.meta[index].id,this.meta[index].meta_main_price]);
        }
      } 
      ...
      let location = (typeof this.location.name === "undefined") ? this.location: this.location.name
    ...
    console.log("Logged Output: original -> booking", booking)
      if (this.booking != null) {
        this.paymentFirstStep();
      }

      // let booking = booking
      const url = `${this.base}booking/special?token=${this.token}`;
      this.$http({
        url: url,
        data: booking,
        method: "POST"
        ...
        .then(res => {
          //proceed to payment, using the presaved payment method
          let bookingData = res.data.data;
          console.log("Logged Output: createBooking -> bookingData", bookingData)
          //Add Discount Here
    ...
    customFormatter(date) {
      return moment(date).format('D/MM/YYYY');
        ...
        let expirationAfter24hrs = Math.floor(currentTime/1000) + timeRangeFor30mins + timeRangeFor24hrs; 
        let cookieData = {
          "now": currentTime,
