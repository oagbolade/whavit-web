    ...
    <div class="dashboard-content-inner">
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
                  ...
                  <div class="row">
                    <div class="col-xl-6">
                      <div class="submit-field">
                        <h5>First Name</h5>
                        <input 
                        type="text" class="with-border" value
          ...
          <div class="col-xl-12">
            <a @click.prevent="updateProfile()" class="button ripple-effect big margin-top-30 text-white">Save Changes</a>
          </div>
        ...
        <!-- Button -->
        <div class="col-xl-12">
          <a @click.prevent="changePassword()" class="button ripple-effect big margin-top-30 text-white">Change Password</a>
        </div>
      </div>
      <!-- Row / End -->
...
mounted() {
    ...
    console.log("Logged Output: mounted -> user",this.user)
