                ...
                <div class="col">
                  <div class="row">
                    ...
                    <div class="col-xl-6">
                      <div class="submit-field">
                        <h5>Email</h5>
                        <input type="text" class="with-border" readonly v-model="user.email" />
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-xl-4">
                  <div class="submit-field">
                    ...
                    <input type="password" class="with-border" v-model="oldPassword" />
                  </div>
                </div>
                ...
                <div class="col-xl-4">
                  <div class="submit-field">
                    <h5>New Password</h5>
                    <input type="password" class="with-border" v-model="newPassword" />
                  </div>
                </div>
                ...
                <div class="col-xl-4">
                  <div class="submit-field">
                    ...
                    <input type="password" class="with-border" v-model="newPassword2" />
                  </div>
                </div>
              </div>
            </div>
...
mounted() {
    ...
    const locationUrl = this.base_url + "location/all";
        let loader = this.$loading.show({
        backgroundColor: "#ffffff",
        opacity: 1,
        zIndex: 9999
    ...
    this.$http({
      ...
      .catch(err => {
        ...
        loader.hide()
        this.$swal.fire({
            text: "Error occured, reload page",
            type: "error"
          });
      });
  }
