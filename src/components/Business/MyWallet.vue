...
export default {
            ...
            this.$http({
              ...
              .then(res => {
                ...
                window.dataLayer.push({
                  ...
                  accountType: "Whavit For Business", //replace with type of account and leave blank where not present
  ...
  mounted() {
    ...
    if (process.env.NODE_ENV == "development") {
      this.callback = "http://localhost:8080/business/dashboard/wallet";
    } else {
      this.callback = "https://whavit.com/business/dashboard/wallet";
    }
