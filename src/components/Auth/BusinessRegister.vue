          ...
          <div class="login-register-page">
            ...
            <form id="register-account-form">
              ...
              <div v-if="$v.form.$error">
                <span
                  class="text-danger text-bold"
                  v-if="!$v.form.businessname.required"
                  >* Business Name is required</span
                >
              </div>
              <div class="input-with-icon-left">
                <i
                  class="icon-material-outline-account-balance"
                  :class="{ 'has-error': $v.form.businessname.$error }"
                ></i>
                <input
                  type="text"
                  class="input-text with-border"
                  name="businessname-register"
                  id="businessname-register"
      ...
      this.$store
        ...
        .then((res) => {
          ...
          window.dataLayer.push({
            ...
            accountType: "Whavit For Business", //replace with type of account whether home, business or cleaner
        ...
        .catch(err => {
          ...
          for (const key in errorObj) {
            if (errorObj.hasOwnProperty(key)) {
              ...
              window.dataLayer = window.dataLayer || [];
              window.dataLayer.push({
                event: "whavit4BusinessFormError",
                accountType: "Whavit For Business", //leave this as it is
